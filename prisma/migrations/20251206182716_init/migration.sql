...
CREATE TABLE "seller_configs" (
    ...
    "default_stock_warning_enabled" BOOLEAN NOT NULL DEFAULT true,
    "default_stock_threshold" INTEGER NOT NULL DEFAULT 5,

    CONSTRAINT "seller_configs_pkey" PRIMARY KEY ("seller_id")
);
...
CREATE TABLE "product_configs" (
    ...
    "stock_threshold_override" INTEGER,
...
-- AddForeignKey
ALTER TABLE "seller_configs" ADD CONSTRAINT "seller_configs_seller_id_fkey" FOREIGN KEY ("seller_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
